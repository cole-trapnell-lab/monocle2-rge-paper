#Analysis for "Reversed graph embedding resolves complex single-cell developmental trajectories"

## Introduction
This distribution includes all analysis and figure generation performed for our manuscript, "Reversed graph embedding resolves complex single-cell developmental trajectories". In order to run all the code included, you need to install six packages we prepared for this project (See more details in file install_packages.R).
